module ArcadeLearningEnvironment_jll
...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import ArcadeLearningEnvironment_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("52cbb755-00ff-5a24-b23e-8a91c598877e"))
platforms = [Pkg.Artifacts.unpack_platform(e, "ArcadeLearningEnvironment", artifacts_toml) for e in artifacts["ArcadeLearningEnvironment"]]
...
if best_platform === nothing
    @debug("Unable to load ArcadeLearningEnvironment; unsupported platform $(triplet(platform_key_abi()))")
else
